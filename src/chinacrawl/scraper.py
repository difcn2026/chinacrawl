...
# Layer L3: Web Scraper �?完整 Firecrawl 平替 (零外部付费依�?
...
CAPABILITIES = {
    ...
    "douyin-user-posts": {"func": "douyin_user_posts", "desc": "Douyin user all posts (XHR intercept)", "fc": "/douyin/user/posts"},
    ...
    "douyin-monitor": {"func": "douyin_monitor_user", "desc": "Douyin user change monitoring", "fc": "/douyin/monitor"},
    "pdd-search": {"func": "pinduoduo_product_search", "desc": "Pinduoduo product search", "fc": "/pinduoduo/search"},
    "pdd-detail": {"func": "pinduoduo_product_detail", "desc": "Pinduoduo product detail", "fc": "/pinduoduo/detail"},
    "pdd-reviews": {"func": "pinduoduo_product_reviews", "desc": "Pinduoduo product reviews", "fc": "/pinduoduo/reviews"},
    "pdd-monitor": {"func": "pinduoduo_monitor_product", "desc": "Pinduoduo product monitoring", "fc": "/pinduoduo/monitor"},
}